...
# =============================================================================
#
# This is an intentional copy of components/py_modules_set_1/pip_install.bzl
# (and components/py_modules_set_2/pip_install.bzl). Bzlmod isolates each
# module's dependency graph and does not support sharing a plain .bzl file
# across module boundaries without introducing a shared library module and
# an extra bazel_dep - the project instead accepts this small duplication,
# consistent with the existing py_modules_set_1 / py_modules_set_2 modules.
#
...
#       requirements = "requirements_rftsm_lock.txt",
