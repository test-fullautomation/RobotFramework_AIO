...
# =============================================================================
#
# Bzlmod isolates each module's dependency graph and does not support sharing
# a plain .bzl file across module boundaries without introducing a shared
# library module and an extra bazel_dep - the project instead accepts this
# small duplication.
#
