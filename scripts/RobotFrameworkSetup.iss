...
Source: "A:\robotframework-tutorial\901_static_code_analysis\*"; Excludes: ".git"; DestDir: {code:GetUsrDataDir}\tutorial\900_building_testsuites; Flags: ignoreversion recursesubdirs overwritereadonly; Permissions: users-full;
