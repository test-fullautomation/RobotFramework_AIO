...
Documentation    test suite 003_2
...
${local_cmdline_var}    local_cmdline_var initial value
...
robot_003_2
    ...
    log    local commandline variable (local_cmdline_var): ${local_cmdline_var}    console=yes
