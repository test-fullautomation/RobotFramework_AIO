...
export RobotPythonPath=/opt/rfwaio/python3/install/bin
export RobotPythonSitePackagesPath=/opt/rfwaio/python3/install/lib/python3.13/site-packages
export RobotScriptPath=/opt/rfwaio/python3/install/bin
