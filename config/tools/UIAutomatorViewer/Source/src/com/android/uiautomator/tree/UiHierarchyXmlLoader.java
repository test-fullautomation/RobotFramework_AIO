...
public class UiHierarchyXmlLoader {
    ...
    static final String ACTIVITY_NAME_REG = ".*dump_(.*)_.*";
    static final Pattern ACTIVITY_NAME_PATTERN = Pattern.compile(ACTIVITY_NAME_REG);
            ...
            public void startElement(String uri, String localName, String qName,
                ...
                if ("hierarchy".equals(qName)) {
                    ...
                    if ((windowName == null) || windowName.isEmpty()) {
                        Matcher matcher = ACTIVITY_NAME_PATTERN.matcher(xmlPath);
                        if (matcher.find()) {
                            windowName = matcher.group(1);
                        }
                    }

                    mWorkingNode = new RootWindowNode(windowName);
                    nodeCreated = true;
